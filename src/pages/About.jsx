              ...
              >
                <Card className="overflow-hidden group p-0">
                  <div className="h-64 overflow-hidden relative">
                    <img src={member.image} alt={member.name} className="w-full h-full object-cover object-top bg-brand-dark transition-transform duration-500 group-hover:scale-105" />
